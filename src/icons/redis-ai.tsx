 ...
 * RedisAI
 */
export const RedisAI: FC<SVGProps> = ({ size, fill, ...rest }) => {
  return (
    <a
      target="_blank"
    ...
    >
      <svg version="1.1" id="RedisAI" x="0px" y="0px" viewBox="0 0 32 32" width={size} height={size} {...rest}>
        <path
          ...
          d="M31.7,14.3l-2-3.9c-0.1-0.2-0.1-0.4-0.1-0.6l-0.1-1.6c-0.1-1-0.8-1.9-1.8-2.2l-1.9-0.4c-0.6-0.1-1-0.7-1-1.3v-1
