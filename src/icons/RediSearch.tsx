 ...
 * RediSearch
 */
export const RediSearch: FC<SVGProps> = ({ size, fill, ...rest }) => {
  return (
    <a
      target="_blank"
      rel="noreferrer"
    ...
    >
      <svg version="1.1" id="RediSearch" x="0px" y="0px" viewBox="0 0 32 32" width={size} height={size} {...rest}>
        <path
          ...
          d="M18.7,5.9c-0.6-0.4-1.2-0.8-1.9-1c-1.5-0.5-3.2-0.5-4.7,0c-0.7,0.2-1.4,0.6-1.9,1c-0.6,0.4-1,0.9-1.4,1.5
